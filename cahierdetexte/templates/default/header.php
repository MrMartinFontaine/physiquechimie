<div id=header>
  ...
  codebase="http://active.macromedia.com/flash4/cabs/swflash.cab#version=4,0,0,0" width="474" height="100">
    ...
    pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash"> </embed>
        ...
        <div class="header_description">
          <div align="center"><a href="<?php echo $_SESSION['url_etab'];?>">
    ...
    <tr>
      ...
      <td><div align="center">
          ...
          <div class="header_description"> <a href="../deconnexion.php">
            <?php if(isset($_SESSION['nom_etab'])){echo $_SESSION['nom_etab'];};?><br/>
            </a>
            <?php 
			if(isset($_SESSION['identite'])&&($_SESSION['droits']==2)){ 
						if(isset($_GET['vie_sco'])){echo $_SESSION['identite'];} else {echo '<img src="../images/identite.gif" />&nbsp;'.$_SESSION['identite'];};
			};?>
            <br /></br>
            <?php echo $header_description;?><br />
          </div>
