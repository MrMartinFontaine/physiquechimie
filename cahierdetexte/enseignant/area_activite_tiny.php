...
<script type="text/javascript">
	...
	tinyMCE.init({
		// General options
		mode : "exact",
		elements : "activite,a_faire_1,a_faire_2,a_faire_3",
		language : "fr", 
		theme : "advanced",
        ...
        browser_spellcheck: true, //car le correcteur orthographique interne du navigateur est desactive par defaut (attribut HTML5 "spellcheck")
		// Theme options
		...
		theme_advanced_buttons2 : "cut,copy,paste,pastetext,pasteword,|,undo,redo,|,link,unlink,image,cleanup,code,|,underline,forecolor,backcolor,sub,sup,|,charmap,emotions,iespell,media,|,ltr,rtl,|,fullscreen",
