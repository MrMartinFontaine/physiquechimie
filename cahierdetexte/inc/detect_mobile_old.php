<?php
$_SESSION['affiche_xinha']=1; //affichage de lediteur xinha - ne fonctionne pas sous ipad, iphone
  $mobile_browser   = false; // set mobile browser as false till we can prove otherwise
  $user_agent       = $_SERVER['HTTP_USER_AGENT']; // get the user agent value - this should be cleaned to ensure no nefarious input gets executed
  if (isset($_SERVER['HTTP_ACCEPT'])){$accept= $_SERVER['HTTP_ACCEPT'];} else {$accept='';}; // get the content accept value - this should be cleaned to ensure no nefarious input gets executed
