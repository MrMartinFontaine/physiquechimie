...
fctOk = function()
{
	...
	objCurrent.style.backgroundColor=strCurrent.toUpperCase();
	if ($('#activite')) { 
	$('#activite').css('color',strCurrent.toUpperCase());
};
	fctHide();
}
...
objSB.Append('<td width="34%" align="center"><input type="button" value="RAZ" class="btnColor" onClick="fctReset();"></td>');
