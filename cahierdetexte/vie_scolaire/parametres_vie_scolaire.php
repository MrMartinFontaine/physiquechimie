...
//parametre autorisant la modification du login
...
//parametre autorisant la modification du mot de passe
mysqli_select_db($conn_cahier_de_texte, $database_conn_cahier_de_texte);
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
	...
	//En cas de remise a blanc, on conserve l'existant 
  ...
  <form method="post" name="form1" action="<?php echo $editFormAction; ?>" onSubmit="return submit_modifpass2();" >
    ...
    <table width="95%" align="center" cellspacing="0" class="lire_cellule_22" >
      ...
      <tr valign="baseline">
        ...
        <br>
        Cette adresse m&eacute;l sera accessible &agrave; la suite de votre nom lorsqu'il sera communiqu&eacute; aux parents et &eacute;l&egrave;ves sur les fiches &quot;travail &agrave; faire&quot;. Cette option peut &ecirc;tre utilis&eacute;e par exemple pour la communication lors d'un soutien aux devoirs.</span></td>
      </tr>
      <tr valign="baseline">
...
if($row_Rsparams_passe['param_val']=='Oui'){ ?>
  ...
  <p><a href="vie_scolaire.php">Annuler</a></p>
  <DIV id=footer>
