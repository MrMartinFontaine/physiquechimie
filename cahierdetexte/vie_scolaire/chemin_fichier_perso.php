...
?>
  ...
  <form name="form1" method="POST" action="chemin_fichier_perso.php">
    <p>&nbsp;</p>
    <p>Chemin d'acc&egrave;s &agrave; mes dossiers depuis la racine  &gt; <em>exemple : /mon_nom/MES_DOSSIERS/ </em> </p>
    <p>
  ...
  <p align="center"> </p>
  <p align="center">&nbsp;</p>
  <p align="center"><a href="vie_scolaire.php">Annuler </a></p>
  <DIV id=footer>
