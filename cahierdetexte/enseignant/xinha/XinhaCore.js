...
this.toolbar=[["popupeditor"],["separator","formatblock","separator","fontname","fontsize"],["separator","bold","italic","underline","strikethrough"],["separator","forecolor","hilitecolor","textindicator"],["separator","subscript","superscript"],["separator","justifyleft","justifycenter","justifyright","justifyfull"],["linebreak","insertorderedlist","insertunorderedlist"],["outdent","indent"],["separator","inserthorizontalrule","createlink","insertimage","inserttable"],["undo","redo","selectall","print"],(Xinha.is_gecko?[]:["cut","copy","paste"]),["killword","clearfonts","removeformat","toggleborders","splitblock","righttoleft","htmlmode","showhelp"]];
this.fontname={"&mdash; font &mdash;":"","Arial":"arial,helvetica,sans-serif","Courier New":"courier new,courier,monospace","Georgia":"georgia,times new roman,times,serif","Tahoma":"tahoma,arial,helvetica,sans-serif","Times New Roman":"times new roman,times,serif","Verdana":"verdana,arial,helvetica,sans-serif","impact":"impact","Symbol":"symbol","WingDings":"wingdings"};
