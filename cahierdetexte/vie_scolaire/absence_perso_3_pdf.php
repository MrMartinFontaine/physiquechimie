...
<?php echo '<p align="center">Etat des pointages du champ "Divers" pour la journ&eacute;e du  '.$jourtoday. '  '.$date1_form;
...
$html2pdf->Output('absence_perso_3.pdf');
?>
